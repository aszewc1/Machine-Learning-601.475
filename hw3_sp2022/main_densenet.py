...
if __name__ == "__main__":
    ...
    if MODE == "train":
        ...
        ### TODO Normalize each of the flattened images in BOTH the training and validation dataset to a mean of 0; variance of 1.
        ...
        ### TODO Set the hidden layer width, input shape, and number of classes for your model, as defined in the class init.
        
        model = TwoLayerDenseNet()
